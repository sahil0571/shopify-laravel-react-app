<script data-turbolinks-eval="false">
    ...
    document.addEventListener(LOAD_EVENT, () => {
        retrieveToken(window.shopify_app_bridge);
        keepRetrievingToken(window.shopify_app_bridge);
    });

    // Retrieve session token
    async function retrieveToken(app) {
        window.sessionToken = window.localStorage.getItem('shopifyAppSesssionToken') ||  await utils.getSessionToken(app);
        ...
        window.localStorage.setItem('shopifyAppSesssionToken', sessionToken);
    }
